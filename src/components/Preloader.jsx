...
function Preloader() {
	...
	return (
		<div className={`group before: after:bg-cinder fixed top-0 z-[9999] flex h-screen w-screen overflow-hidden ${loaded ? 'loaded' : ''}`}>
			...
			<div className={`group relative z-[555] m-auto h-[1px] w-1/2 overflow-hidden transition-all duration-800 [.loadedline]:w-full [.loadedline]:opacity-0 ${loadedLine ? 'loadedline' : ''}`}>
