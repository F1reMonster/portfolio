...
function ThemeSwitcher() {
	...
	return (
		<div className="absolute top-2.5 right-2.5 z-50 lg:top-4 lg:right-4">
			<button role="buttom" onClick={themeHandler} className="flex h-8 w-8 cursor-pointer items-center justify-center rounded bg-black text-white dark:bg-white dark:text-black">
				{darkTheme ? <SunIcon /> : <MoonIcon />}
			</button>
		</div>
	);
